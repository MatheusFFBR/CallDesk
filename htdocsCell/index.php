...
<div class="centro">
    <div id="box_login" class="conteudo">
        ...
        <div>
            ...
            <!-- VERIFICA SE EXISTE ERROR NO SISTEMA -->
            <?php
            if (isset($_SESSION['system_error'])):
                if($_SESSION['system_error_message'] == "system_login_inativo_db"){
                ?>
                <div class="error_notificacao alert alert-danger" role="alert">
                    O Login esta desabilitado, contate o Administrador do Sistema!
                </div>
            <?php
            }
            endif;
        ...
        <form class="floating-form" action="/home/Auth/login.php" method="post" autocomplete="off">
            ...
            <!-- INPUT FILD SENHA -->
            <div class="floating-label">
                <input class="floating-input pass_secure input_color" type="text" placeholder=" " name="user_post_pass"">
                <span class="highlight"></span>
                <label>Senha</label>
            </div>
            <!-- BOTÃO ENTRAR -->
            <div class="form-group">
                <button type="submit" class="btn btn-success btn-block btn-lg" id="butao_entrar">Entrar</button>
            </div>
            <!-- BOTAO REGISTRAR -->
            <div class="form-group" >
